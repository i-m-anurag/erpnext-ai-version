...
const ALL_MODULES: ErpModule[] = [
  ...
  },
  {
    ...
    subModules: [
      ...
      { slug: 'stock-entries', name: 'Stock Entries', icon: 'ph-clipboard-text' },
      { slug: 'movements', name: 'Stock Ledger', icon: 'ph-arrows-left-right' },
  ...
  },
  {
    ...
    subModules: [
      ...
      { slug: 'receipts', name: 'Purchase Receipts', icon: 'ph-package' },
